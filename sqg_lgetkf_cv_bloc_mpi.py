...
import sys, time, os
from sqgturb import SQG_mpi, rfft, ifft2, fft_forward, fft_backward, cartdist, lgetkf_bloc, gaspcohn, newDistArrayGrid, newDistArraySpec, MPI, eigh
...
if rank == 0:
    ...
    tdiab=None; L=None; dt=None; f=None; U=None; H=None; nsq=None; scalefact=None; diff_order=None; diff_efold=None; r=None; tstart=None
...
for nanal in range(nanals):
    models.append(\
    SQG_mpi(pvens[nanal],dt=dt,nsq=nsq,f=f,U=U,H=H,r=r,tdiab=tdiab,diff_order=diff_order,diff_efold=diff_efold,threads=threads))
...
for ntime in range(nassim):
    ...
    xens = lgetkf_bloc(xens, pvob-hxensmean_b, oberrvar, sqrtcovlocal_local, covlocal_ob, indxob, covlocal_model, scalefact, ngroups=ngroups, npts_dist=npts_dist)
