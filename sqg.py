...
class SQG:
    ...
    def gettend(self,pvspec=None):
        ...
        u = irfft2(-self.il*psispec); v = irfft2(self.ik*psispec)
        pvx = irfft2(self.ik*pvspec); pvy = irfft2(self.il*pvspec)
        dpvspecdt = (1./self.tdiab)*(self.pvspec_eq-pvspec)-rfft2(u*pvx+v*pvy)
