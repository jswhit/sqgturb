...
# LGETKF cycling for SQG turbulence model with vertical mean temp obs,
...
for ntime in range(nassim):
    ...
    pvob = scalefact*meanpv_truth.reshape(nx*ny)[indxob]
    ...
    for nanal in range(nanals):
        ...
        hxens[nanal,...] = scalefact*meanpv.reshape(nx*ny)[indxob] # mean temp obs
