...
import numpy as np
import sys, os
from sqgturb import SQG, SQGrandom, RandomPattern, rfft2, irfft2
...
stdev = 0.2e6
rp = RandomPattern(250.e3,6.*nc.dt,nc.L,pv.shape[-1],dt=nc.dt,stdev=stdev,nsamples=2)
model = SQGrandom(pv,nsq=nc.nsq,f=nc.f,U=nc.U,H=nc.H,r=nc.r,tdiab=nc.tdiab,dt=dt,
