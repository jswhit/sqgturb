...
if rank == 0:
    ...
    hcovlocal_scales=None; vcovlocal_facts=None; band_cutoffs=None; nband_cutoffs=None; nlscales=None; crossbandcov_facts=None

hcovlocal_scales = comm.bcast(hcovlocal_scales, root=0)
vcovlocal_facts = comm.bcast(vcovlocal_facts, root=0)
...
for ntime in range(nassim):
    ...
    xens = lgetkf_ms_vloc(nlscales,xens,xens2,hxprime,hxprime2,pvob-hxensmean_b,oberrvar,covlocal_tmp,ngroups=ngroups,npts_dist=npts_dist)
