...
for ntime in range(nassim):
    ...
    for n in range(nx*ny):
        ...
        #    xprime_squeeze[nanal1:nanal2] = squeezefact[np.newaxis,np.newaxis,nlscale,:]*xprime[nanal1:nanal2]
