...
import sys, time, os
from sqgturb import SQG, rfft2, irfft2, cartdist, lgetkf2, gaspcohn
...
for ntime in range(nassim):
    ...
    xens = lgetkf2(xens,xens2,hxens,hxens2,pvob,oberrvar,covlocal_tmp,vcovlocal_sqrt,nanal_index)
