...
# additive inflation coefficient.
addinflate = float(sys.argv[2])
# multiplicative inflation parameters
...
# additive inflation perturbations (generated by sqg_genperts.py)
nc_perts = Dataset('data/N256_N64_errperts.nc')
pv_perts = nc_perts.variables['pv']
...
for ntime in range(nassim):
    ...
    if covinflate2 < 0:
        ...
        covinflate1*(asprd/fsprd)**2*((fsprd/nanals) + covinflate2*(2.*inc**2/(nanals-1)))
    ...
    #indxran.sort()
    #pvperts = (pv_a_in[indxran+200] - pv_b_in[indxran+200]).mean(axis=1)
