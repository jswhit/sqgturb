...
Nout = 512  # number of points on output grid (N should be a multiple of Nout)
if N%Nout != 0:
...
tmax = 2300.*86400. # time to stop (in days)
nsteps = int(tmax/dt) # number of time steps to animate
savedata = False # save data plotted in a netcdf file.
