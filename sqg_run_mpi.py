from sqgturb import SQG_mpi, MPI
import numpy as np
import os, time
...
model = SQG_mpi(pv,nsq=nsq,f=f,U=U,H=H,r=r,tdiab=tdiab,dt=dt,
...
savedata = 'sqgu%s_N%s_6hrly_24hdiff_mpi.nc' % (U,N) # save data plotted in a netcdf file.
